...
constexpr long OFF_NAMEINDEX = 0x057c; //0x38; //[RecvTable.DT_BaseEntity]->m_instanceNameIndex
...
constexpr long OFF_WEAPON_AMMO = 0x1580; //[DataMap.CWeaponX]->m_ammoInClip
...
constexpr long OFF_PROJECTILESCALE = 0x04ec + 0x19c0; //0x1e84; //CWeaponX!m_flProjectileScale //[WeaponSettings]->projectile_gravity_scale + [WeaponSettingsMeta].base
constexpr long OFF_PROJECTILESPEED = 0x04e4 + 0x19c0; //0x1e7c; //CWeaponX!m_flProjectileSpeed //[WeaponSettings]->projectile_launch_speed + [WeaponSettingsMeta].base
...
constexpr long OFF_GLOW_HIGHLIGHTS = 0xBB24350; //0xB944E30;
